// scripts/reset-four.ts
//
// Resets the paper-bot arena to the v4 4-bot test setup:
//
...
//
// Wipes ALL paper_positions, deletes any bot row not in the v4
// roster, then upserts the 4 with fresh $10,000 balances. Safe to
// rerun (idempotent).
